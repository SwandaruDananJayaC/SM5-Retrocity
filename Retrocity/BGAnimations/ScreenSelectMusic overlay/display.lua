...
local difficulty_positions= {
	[PLAYER_1]= {_screen.cx-308, _screen.cy+70},
	[PLAYER_2]= {_screen.cx-203, _screen.cy+70}
}
...
t[#t+1] = LoadActor("_dfp1") .. {
	InitCommand=cmd(x,SCREEN_CENTER_X-350;y,SCREEN_CENTER_Y+71;visible,not GAMESTATE:IsCourseMode(););
	OffCommand=cmd(bouncebegin,0.5;addx,-SCREEN_WIDTH*0.6);
	OnCommand=cmd(addx,-SCREEN_WIDTH*0.6;bounceend,0.5;addx,SCREEN_WIDTH*0.6;);
	}
	
t[#t+1] = LoadActor("_dfp2") .. {
	InitCommand=cmd(x,SCREEN_CENTER_X-450+180;y,SCREEN_CENTER_Y+71;visible,not GAMESTATE:IsCourseMode(););
	OffCommand=cmd(bouncebegin,0.5;addx,-SCREEN_WIDTH*0.6);
	OnCommand=cmd(addx,-SCREEN_WIDTH*0.6;bounceend,0.5;addx,SCREEN_WIDTH*0.6;);
	}	
...
t[#t+1] = LoadFont("_neuropol 36px") .. { 
          InitCommand=cmd(x,SCREEN_CENTER_X-350+32;y,SCREEN_CENTER_Y+71-10;horizalign,right;diffuse,PlayerColor(PLAYER_1);zoom,0.6); 
...
t[#t+1] = LoadFont("_neuropol 36px") .. { 
          InitCommand=cmd(x,SCREEN_CENTER_X-450+180-32;y,SCREEN_CENTER_Y+71-10;horizalign,left;diffuse,PlayerColor(PLAYER_2);zoom,0.6);
		  OnCommand=cmd(diffusealpha,0;sleep,0.3;smooth,0.2;diffusealpha,1;);
		  OffCommand=cmd(bouncebegin,0.5;addx,-SCREEN_WIDTH*0.6);
