...
t[#t+1] =Def.ActorFrame{
		...
		InitCommand=cmd(x,SCREEN_CENTER_X-SCREEN_WIDTH;y,SCREEN_CENTER_Y);
		OnCommand=cmd(linear,0.25;x,SCREEN_CENTER_X);
	};		
...
t[#t+1] = Def.Quad{
	OnCommand=cmd(diffuse,color("#000000");Center;setsize,486,486;diffusealpha,0;zoom,4;sleep,0.9;linear,0.2;diffusealpha,1;zoom,1);
	};
